const kissOfDeceptionQuotes = [
    {
        quote: "Today was the day a thousand dreams would die and a single dream would be born.",
    ...
    {
        quote: "Taking another life, even a quilty one, should never be easy.",
    ...
    {
        quote: "Who was this girl who thumbed her nose at two kingdoms?",
    ...
    {
        quote: "There were two ways to approach the innevitable: Being dragged to meet your fate or taking the offensive",
...
const heartOfBetryalQuote = [
    {
        quote: "If one can't be trusted in love, one can't be trusted in anything. Some things can't be forgiven.",
    ...
    {
        quote: "Maybe there was no one way to define it. Maybe there were as many shades of love as the blues of the sky.",
    ...
    {
        quote: "The prince has grand dreams. Is it worth it to have any other kind?",
...
const beautyOfDarknessQuotes = [
    {
        quote: "It doesn't matter how many universes come and go. I will always remember who were together.",
    ...
    {
        quote: "You couldn't command love to stop any more than marriage document could order it to appear. Maybe love had to bleed away a drop at a time until your heart was numb and cold and mostly dead. ",
    ...
    {
        quote: "When we lose a battle, we have to regroup and move forward again. Choose an alternate path if necessary. But if we dwell on every action we've taken, it will cripple us, and soon we'll take no action at all.",
    ...
    {
        quote: "It was only me, a thousand blinking stars, and the beauty of darkness stretched to the ends of the universe, snuffing out the endless games of courts and kingdoms.",
